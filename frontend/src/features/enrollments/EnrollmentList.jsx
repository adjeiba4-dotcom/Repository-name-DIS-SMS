...
/**
 * Active / archived enrollment directory powered by shared DataTable.
 */
export default function EnrollmentList({
  ...
  return (
    <DataTable
      ...
      title={
        title ||
        (isArchived ? "Archived Enrollments" : "Enrollment Directory")
      }
      description={
        description ||
        (isArchived
          ? "Soft-deleted enrollments. Restore to return them to the active directory."
          : "Place students into classes for an academic year, with capacity and uniqueness guards.")
      }
      columns={COLUMNS}
      rows={rows}
      loading={loading}
      ...
      emptyTitle={
        isArchived ? "No archived enrollments" : "No enrollments found"
      }
      emptyDescription={
        isArchived
          ? "Archived records will appear here after soft-delete."
          : "Try adjusting search or filters, or enroll a student."
      }
      ...
      searchable
      search={search}
      searchLabel={isArchived ? "Search archived" : "Search enrollments"}
      searchPlaceholder="Search by enrollment no, student, class, or year…"
