...
/**
 * Active / archived academic year directory powered by shared DataTable.
 */
export default function AcademicYearList({
  ...
  return (
    <DataTable
      ...
      title={
        title ||
        (isArchived ? "Archived Academic Years" : "Academic Year Directory")
      }
      description={
        description ||
        (isArchived
          ? "Soft-deleted academic years. Restore to return them to the active directory."
          : "Manage academic years. Only one year can be Active at a time.")
      }
      columns={COLUMNS}
      rows={rows}
      loading={loading}
      ...
      emptyTitle={
        isArchived ? "No archived academic years" : "No academic years found"
      }
      emptyDescription={
        isArchived
          ? "Archived records will appear here after soft-delete."
          : "Try adjusting search or filters, or create a new academic year."
      }
      ...
      searchable
      search={search}
      searchLabel={isArchived ? "Search archived" : "Search academic years"}
