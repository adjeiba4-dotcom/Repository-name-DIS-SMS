          ...
          <li key={action.id}>
            <Link
              ...
              className={cn(
                ...
                "bg-[var(--color-surface-muted)] px-[var(--space-3)] py-[var(--space-3)]",
                "text-left transition-[background-color,border-color,box-shadow] duration-[var(--transition-normal)]",
                "hover:border-[var(--color-border-default)] hover:bg-[var(--color-button-secondary-hover)] hover:shadow-[var(--shadow-sm)]",
            ...
            >
              <span className="min-w-0">
                ...
                <Caption variant="muted" size="sm" className="m-0 mt-[var(--space-1)]">
                  {action.description}
                </Caption>
              </span>
              <ArrowUpRight
                size={16}
                className="shrink-0 text-[var(--color-text-muted)] transition-colors duration-[var(--transition-fast)] group-hover:text-[var(--color-brand-600)]"
                aria-hidden
              />
            </Link>
          </li>
